...
export async function POST(req) {
  ...
  try {
    await resend.emails.send({
      from: 'CC Creator <noreply@kitifica.com>',
      to: email,
      subject: 'Tu enlace de acceso a CC Creator',
      html: `
        <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;max-width:520px;margin:0 auto;background:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.06);">
          ...
          <div style="padding:36px 36px 28px;">
            <div style="display:flex;align-items:center;gap:10px;margin-bottom:28px;">
              ...
              <span style="font-size:15px;font-weight:800;color:#1a1a1a;letter-spacing:-0.02em;">CC Creator</span>
            </div>
            ...
            <a href="${magicLink}" style="display:block;background:#f04e23;color:#ffffff;text-decoration:none;border-radius:14px;padding:15px 28px;font-size:14px;font-weight:700;text-align:center;">Entrar a CC Creator →</a>
          </div>
